[document]
CGS_VERSION = "3.1.2"
generated_at = "2026-09-24T11:45:39Z"
command_origin = "commit"
hash_canonicalisation = 3
snapshot_hash = "63a9fffdc5ade566180cebccbe404bced7e43e88c54454fc2c43c8041fe4c617"
...
[tree]
lines = [
    "ComplexGitSync (root) [ALIGNED] @66cf81b br=main",
    ...
    "├── .localSpec (leaf) [ALIGNED] @7218f38 br=ComplexGitSync fb=main",
    "├── .versioning (leaf) [ALIGNED] @15bae0a br=ComplexGitSync fb=main",
    "├── .memory (parent) [ALIGNED] @23752bd br=ComplexGitSync",
    "│   └── .self-history (leaf) [ALIGNED] @6e3b393 br=ComplexGitSync fb=main",
    "└── DocComplexGitSync (leaf) [ALIGNED] @d4789b2 br=main",
]
...
sync_state = "ALIGNED"
commit_sha = "66cf81b68bcc16f800abc479bafdc859cd38ee81"
...
repo_lifecycle_state = "READY"
sync_state = "ALIGNED"
commit_sha = "7218f380ce435c9ab02e8dca9ce264dafd01affc"
worktree_state = "DIRTY"
source_cgs_path = "$CGSTREE/examples/complexgitsync4dev.cgs"
project_owner_name = "flipoyo"
...
repo_lifecycle_state = "READY"
sync_state = "ALIGNED"
commit_sha = "23752bd4cd41e29c1ab3233439e54725b98d3550"
worktree_state = "CLEAN"
...
repo_lifecycle_state = "READY"
sync_state = "ALIGNED"
commit_sha = "d4789b23f3bfa826d980b382622f03501695073f"
worktree_state = "DIRTY"
