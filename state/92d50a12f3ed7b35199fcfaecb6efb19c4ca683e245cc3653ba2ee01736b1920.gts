[document]
CGS_VERSION = "0002.72"
generated_at = "2026-09-17T12:51:57Z"
command_origin = "pull"
hash_canonicalisation = 3
snapshot_hash = "92d50a12f3ed7b35199fcfaecb6efb19c4ca683e245cc3653ba2ee01736b1920"
...
[tree]
lines = [
    "ComplexGitSync (root) [ALIGNED] @0afd9eb br=memory-dev fb=main",
    "├── .agentSpec (parent) [ALIGNED] @62f684a br=main",
    "│   └── DevSpec (leaf) [ALIGNED] @a5d3432 br=main",
    "├── .memory (leaf) [ALIGNED] @bdbabc7 br=ComplexGitSync_memory-dev fb=main",
    "├── .claude (leaf) [ALIGNED] @c30e651 br=ComplexGitSync_memory-dev fb=main",
    "├── .localSpec (leaf) [ALIGNED] @078fe32 br=ComplexGitSync_memory-dev fb=main",
    "└── DocComplexGitSync (parent) [ALIGNED] @0015aec br=memory-dev fb=main",
